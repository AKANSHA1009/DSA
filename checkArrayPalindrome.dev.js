...
function isPalindromeBruteForce(arr) {
  ...
  var reversedArray = arr.slice().reverse(); // Use slice() to avoid modifying the original array
...
var inputArray = [1, 2, 3, 2, 1];
var result = isPalindromeBruteForce(inputArray);
