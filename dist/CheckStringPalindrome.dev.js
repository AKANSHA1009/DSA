...
function isPalindrome(str) {
  ...
  var normalizedStr = str.toLowerCase().replace(/[^a-z0-9]/g, ''); // Reverse the string

  var reversedStr = normalizedStr.split('').reverse().join(''); // Compare the original string with the reversed string
